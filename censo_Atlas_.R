...
censo2=melt(setDT(censo), id=1:2,
...
censo2=censo2 %>%
  mutate(Regiões= recode_factor(ab_uf,
          "AC"=reg[1],"AL"=reg[5],"AP"=reg[1],"AM"=reg[1],"BA"=reg[5],
...
# Alternativas gráficas interessantes
library(ggExtra) # Acrescentando marges

ggMarginal(g1, type = "histogram" )

ggMarginal(g1, type = "histogram" , col="orange",fill="darkblue")
